...
const projects = [
  // ===== ALL =====
  { title: "물리고 이상현상대응부", category: "게임", desc: "제작 중", tags: ["물리 방탈출", "물리학"], emoji: "❤️", demo: "./muligo/index.html", curriculumId: "ALL", thumb: "./thumb_nail/물리고.png" },
  ...
  { title: "축전기", category: "전자/반도체", desc: "극판 면적, 간격, 유전체에 따른 전기용량과 RC 충방전 곡선을 관찰하기", tags: ["축전기", "전기용량", "RC회로", "에너지저장"], emoji: "🔋", demo: "./simul/축전기.html", curriculumId: "[12물리02-03], [12전자01-06]", thumb: "./thumb_nail/축전기.svg" },
  ...
  { title: "아인슈타인 엘리베이터", category: "상대성", desc: "가속하는 엘리베이터와 중력의 등가원리! 빛이 휘는 원리를 직접 확인하기", tags: ["등가원리", "일반상대성", "중력렌즈", "빛"], emoji: "🛗", demo: "./simul/일반상대론.html", curriculumId: "[12역학01-06]", thumb: "./thumb_nail/일반상대론.png" },
