...
{title: "위치와 변위",  category: "역학",  desc: "선을 그려 이동거리와 변위의 차이를 눈으로 확인하기 (직선 그리기 도전!)",  tags: ["이동거리", "변위", "벡터"],  emoji: "📏",  demo: "./simul/위치와 변위.html",  curriculumId: "[12물리01-02]",  thumb: "./thumb_nail/위치와_변위.png"},
